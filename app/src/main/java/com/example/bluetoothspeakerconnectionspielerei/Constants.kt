...
class Constants private constructor(){
    companion object{
        ...
        @JvmField val BLUETOOTH_DEVICE_MAJOR_CLASS = mapOf(BluetoothClass.Device.Major.AUDIO_VIDEO to "Audio/Video",
        ...
        @JvmField val BLUETOOTH_DEVICE_TYPE = mapOf(BluetoothDevice.DEVICE_TYPE_CLASSIC to "BR/EDR", BluetoothDevice.DEVICE_TYPE_LE to "LE-only",
